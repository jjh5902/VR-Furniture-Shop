...
public class OVRDebugInfo : MonoBehaviour
{
    ...
    /// </summary>
    public float riftPresentTimeout = 0.0f;
    ...
    void Awake()
    {
        ...
        debugUIManager.name = "DebugUIManager2";
    ...
    void InitUIComponents()
    {
        ...
        debugUIObject.name = "HeightInput";
        debugUIObject.transform.parent = GameObject.Find("DebugUIManager2").transform;
